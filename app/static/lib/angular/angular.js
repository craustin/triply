 ...
 * 
 * <pre>
 * var triplyApp = angular.module('triplyApp', []);
 * triplyApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://triplyApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://triplyApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('triplyApp', []).config(function($sceDelegateProvider) {
 ...
 *        'http://triplyApp.example.com/clickThru**']);
 *      });
 * </pre>
 */
 ...
 * @example
 <example module="mySceApp">
  <file name="index.html">
    <div ng-controller="triplyAppController as myCtrl">
  ...
  <file name="script.js">
    ...
    mySceApp.controller("triplyAppController", function triplyAppController($http, $templateCache, $sce) {
      var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('triplyAppWithSceDisabledtriplyApp', []).config(function($sceProvider) {
